...
public class ejercicio_4 {
	public static void main(String[] arg) {
		/*
		 * preparamos la presentación del programa en forma de un menu para poder elegir
		 * la opción deseada
		 */
		...
		// aqui entra en accion la condición del bucle
		...
		while (num != 3) {
			...
			// en este paso según lo que hallamos elegido tomará un paso u otro
			...
			// cuando termina la operación nos muestra de nuevo el menú
			// y según lo que pongamos empieza de nuevo el bucle o salimos.
		...
		sr.close();
		// si hemos elegido el número 3 el programa salta hasta aquí y nos muestra
